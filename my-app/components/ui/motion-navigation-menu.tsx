  ...
  return (
    <HighlightItem asChild>
      <a
        ...
        className={cn(
          "data-[active=true]:text-on-dark hover:text-on-dark focus:text-on-dark focus-visible:ring-ring/50 [&_svg:not([class*='text-'])]:text-on-dark-mute flex flex-col gap-1 rounded-sm p-2 text-sm transition-colors outline-none focus-visible:ring-[3px] focus-visible:outline-1 [&_svg:not([class*='size-'])]:size-4",
          className,
        )}
        {...props}
      />
...
function MotionNavigationMenuIndicator({
  ...
  return (
    <div
      ...
      {...props}
    >
      <div className="bg-hairline-dark relative top-[60%] h-2 w-2 rotate-45 rounded-tl-sm shadow-md" />
    </div>
  );
}
